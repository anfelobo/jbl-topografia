...
function WhatsAppButton() {
  return (
    <a
      ...
      target="_blank"
      className="fixed bottom-6 right-6 bg-white p-2 rounded-full shadow-lg hover:scale-110 transition flex items-center justify-center"
      aria-label="WhatsApp"
      style={{ width: 64, height: 64 }}
    >
      <span className="w-12 h-12 block">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 175.216 175.552" width="48" height="48">
          <defs>
